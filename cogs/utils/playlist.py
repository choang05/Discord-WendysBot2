...
class Playlist(EventEmitter):
    ...
    # async def move_entry(self, currentIndex, newIndex):
    #     """
    #         Removes a song from the playlist.
    #         :param index: The index of the song to remove from the queue.
    #     """
    #     print (self.entries[currentIndex])
    #     print (self.entries[newIndex])
    #
    #     self.entries.insert(newIndex, self.entries(currentIndex))
    #
    #     print (self.entries[currentIndex])
    #     print (self.entries[newIndex])
    #
    #     return self.entries[newIndex]
